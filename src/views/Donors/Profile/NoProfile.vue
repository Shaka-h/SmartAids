<template>
    ...
    <div class="card_container">
        ...
        <div class="card">
          ...
          <div class="title">
            <span>Hi, Welcome to Alphaconnect !!!</span>
          </div>
          <div class="paragraph">
            <span>To Experience fully our features create your profile and meet the rest of the community</span>
          </div>
          <div class="flex justify-center items-center mt-10 ">
            <div @click="createProfile" class="px-4 rounded-lg bg-primary2 justify-center p-4 font-bold w-1/4 flex items-center cursor-pointer ">
                CREATE PROFILE
            </div>
          </div>
...
.card_container .card .icon_say-hi {
  width: 3.5rem;
